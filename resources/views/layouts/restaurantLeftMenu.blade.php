<div style="height: 70vh; width: 28vw;" class="pb-5 flex flex-col top-48 left-8 fixed items-end bg-white shadow-lg rounded-xl">
    ...
    <div style="width:90%" class="mt-5 flex-col flex justify-center items-center">
        ...
        <a href="{{route('productos.index')}}" style ="width: 90%;" class="pl-5 @yield('productosSeleccionados') hover:bg-gray-200 text-blue-950 mt-2  text-xl rounded ">Productos</a>
    </div>
...
<div style="border-radius: 200px; height: 200px; width: 200px;" class="rounded border-blue-800 border-xl border-8 top-16 left-32 fixed bg-white shadow-lg">
