<div id="modalAgregarOpcionSeccion" class="fixed inset-0 flex justify-center items-center z-10 hidden">
    <div style="height: 90vh; width: 50vw;" class="bg-white flex justify-center items-center flex-col shadow-lg rounded-xl">
      ...
      <form action="{{ route('section_options.store') }}" method="POST" class="mt-5 flex justify-center items-start flex-col space-y-5">
        ...
        <div>
          <label style="width:160px;" class="pb-5 pr-5 text-blue-900 font-medium">Máximo:</label>
          <input class="border-blue-900 border rounded pt-1 pb-1 pl-2 border focus:outline-none" type="number" name="maximo" placeholder="Máximo">
        </div>
        <div>
          <label style="width:160px;" class="pb-5 pr-5 text-blue-900 font-medium">Mínimo:</label>
          <input class="border-blue-900 border rounded pt-1 pb-1 pl-2 border focus:outline-none" type="number" name="minimo" placeholder="Mínimo">
        </div>
        <div>
