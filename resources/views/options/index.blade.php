        ...
        <div style="width: 80%;" class="mt-28">
            <div class="container mx-auto flex flex-col items-center">
                @if($options->count() == 0)
                    ...
                    <h1 class="font-bold text-5xl w-4/5 text-center text-blue-700">¡Parece que no tienes ningún extra aún!</h1>

                    <p class="mt-10 text-2xl w-4/5 text-center">Agrega un extra para empezar</p>
                ...
                <table>
                    ...
                    @foreach($options as $option)
                      <tr>
                        <td class="pl-5 pr-5 text-center">{{ $option->nombre }}</td>
                        <td class="pl-5 pr-5 text-center">${{ $option->precio }}</td>
                        <td class="pl-5 pr-5 text-center">
                          @if($option->disponibilidad)
                            Si
                          @else
                            No
                          @endif
